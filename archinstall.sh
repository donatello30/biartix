#!/bin/bash
# Todo lo que sigue es despues de haber hecho el pacstrap /mnt base base-devel
# Y el arch-chroot /mnt
...
pacman -S grub os-prober efibootmgr networkmanager network-manager-applet linux-headers dosfstools xdg-user-dirs xdg-utils intel-ucode acpid reflector
